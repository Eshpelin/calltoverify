/** The widget's bold, branded look. All visual values are CSS custom properties so
 *  integrators can re-theme by passing `theme` to mount() or overriding the
 *  --ctv-* variables in their own CSS. */
export const css = `
.ctv-widget {
  --ctv-brand: #4f46e5;
...
.ctv-action b { color: var(--ctv-text); font-weight: 600; }
...
.ctv-num { font-size: 21px; font-weight: 700; text-align: center; margin: 2px 0 16px; letter-spacing: 0.01em; }
...
.ctv-btn-ghost {
  display: inline-block; background: none; border: none; color: var(--ctv-brand);
...
.ctv-final-num { font-size: 15px; font-weight: 600; font-variant-numeric: tabular-nums; margin: 0 0 12px; }

@media (prefers-color-scheme: dark) {
  .ctv-widget {
    --ctv-bg: #15151f; --ctv-surface: #20202e; --ctv-text: #f1f1f6;
    --ctv-muted: #9a9ab0; --ctv-border: rgba(255,255,255,0.12);
    --ctv-brand: #7c74ff; --ctv-brand-strong: #6a61f0; --ctv-digit: #cfcaff;
  }
...
export function ensureStyles(doc: Document): void {
  if (doc.getElementById("ctv-widget-styles")) return;
