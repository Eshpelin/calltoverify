/** User-facing copy. Override any field via the `labels` mount option to translate
 *  or re-voice the widget. The copy deliberately reframes the flow: the user reaches
 *  out, it is free, and it is detected automatically. */
